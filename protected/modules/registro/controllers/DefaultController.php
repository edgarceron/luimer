...
class DefaultController extends Controller
{
	...
	public function actions()
	{
		return array(
			...
			'nuevaVenta'=>'application.modules.'.$this->module->id.'.controllers.acciones.NuevaVentaAction',                            
			'verificar'=>'application.modules.'.$this->module->id.'.controllers.acciones.VerificarAction',                            
			'formularioCliente'=>'application.modules.'.$this->module->id.'.controllers.acciones.FormularioClienteAction',                            
			'formularioCompra'=>'application.modules.'.$this->module->id.'.controllers.acciones.FormularioCompraAction',                            
			'cobros'=>'application.modules.'.$this->module->id.'.controllers.acciones.CobrosAction',                            
		);
	}
    ...
    public function accessRules()
	{
		return array(	
			...
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('nuevaVenta'),
                                'expression' => array(__CLASS__,'allowIndex'),
                            ),
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('verificar'),
                                'expression' => array(__CLASS__,'allowIndex'),
                            ),
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('formularioCliente'),
                                'expression' => array(__CLASS__,'allowIndex'),
                            ),
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('formularioCompra'),
                                'expression' => array(__CLASS__,'allowIndex'),
                            ),
			array('allow', // allow only the owner to perform 'view' 'update' 'delete' actions
                                'actions' => array('cobros'),
                                'expression' => array(__CLASS__,'allowIndex'),
                            ),
